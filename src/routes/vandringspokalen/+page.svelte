<script>
  ...
  function initOrReset() {
    ...
    title = data.page?.title || 'Vandringspokalen';
    ...
    vandringspokalen = data.page?.vandringspokalen ||
...
<svelte:head>
  <title>Vandringspokalen | Turf Västerbotten</title>
</svelte:head>
...
<div class="py-12 sm:py-24">
  <div class="max-w-screen-md mx-auto px-6 md:text-xl">
    ...
    <div class="prose md:prose-xl pb-0 sm:pb-0">
      <RichText multiLine bind:content={vandringspokalen} />
    </div>
  </div>
</div>
...
<Footer counter="/vandringspokalen" />
