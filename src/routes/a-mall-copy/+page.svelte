<script>
  ...
  function initOrReset() {
    ...
    title = data.page?.title || 'Mallsida';
...
<svelte:head>
  <title>Mallsida | Turf Västerbotten</title>
</svelte:head>
...
<div class="py-12 sm:py-24">
  <div class="max-w-screen-md mx-auto px-6 md:text-xl">
    ...
    <div class="prose md:prose-xl pb-0 sm:pb-0">
      <RichText multiLine bind:content={mall} />
    </div>
  </div>
</div>
...
<div class="bg-white">
  <div class="max-w-screen-md mx-auto px-6">
    <div class="font-bold text-sm sm:text-base pt-0 sm:pt-0 -mb-6 md:-mb-12">MALL</div>
